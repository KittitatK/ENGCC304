...
int main(){
    ...
    //สต๊อกเงิน
    int stock_m1 = 1000, stock_m2 = 1000, stock_m5 = 1000, stock_m10 = 1000, stock_m20 = 1000, stock_m50 = 1000, stock_m100 = 1000; //จำนวนเงิน แบงค์ทุกแบงค์ 1000 ใบ เหรียญทุกเหรียญ 1000 เหรียญ
    //เงินที่จ่าย
   ...
   while(Condition){
                ...
                if(choice == '0'){ //สรุปคำสั่งซื้อ
                    ...
                    if(choice == 'Y' || choice == 'y' || choice == 1){//ยืนยันชำระเงิน
                        ...
                        if ( paid > total ){// if ทอนเงิน
                            change = paid - total;
                            printf("\nคุณชำระเงิน %d บาท ",paid);
                            printf(" \nจำนวนเงินที่ต้องทอน %d บาท\n", change);
        ...
        printf("\nต้องการสินค้าเพิ่มเติมไหม? Y(1) / N(0) : ");
        scanf("%d",&choice);

        if(choice == 0){//ยกเลิกรายการสินค้า
            printf("ขอบคุณที่ใช้บริการ");
            Condition = false;
            break;
        }else{
            ...
            pay_m1 = 0, pay_m2 = 0, pay_m5 = 0, pay_m10 = 0, pay_m20 = 0, pay_m50 = 0, pay_m100 = 0;
            c_m1 = 0, c_m2 = 0, c_m5 = 0, c_m10 = 0, c_m20 = 0, c_m50 = 0, c_m100 = 0;

            // reset ตัวแปรเพิ่ม/ลดสินค้า
            sunflower_up = 0; 
            bean_up = 0; 
            jinmok_up = 0;
